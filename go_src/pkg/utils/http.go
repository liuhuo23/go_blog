...
func (hr *HttpRequest) Request(method string,
	url string,
	body io.Reader,
	args ...any) *HttpRequest {
...
//ParseBytres Parse the return value into []byte format
...
//Raw Return the raw response data as string
